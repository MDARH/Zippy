...
@section('page_title')
    {{ __('admin::app.conversation.title') }}
@stop

@section('content-wrapper')

    <div class="content full-page conversation">
        <div class="page-header">
            <div class="page-title">
                <h1>{{ __('admin::app.conversation.title') }}</h1>
            </div>
        ...
        <div class="page-content">
            ...
            <div class="conversation-stats">
                ...
                <div class="conversation-card">
                    <div class="title">
                        {{ __('admin::app.conversation.total-customers') }}
                    </div>
                ...
                <div class="conversation-card">
                    <div class="title">
                        {{ __('admin::app.conversation.total-orders') }}
                    </div>
                ...
                <div class="conversation-card">
                    <div class="title">
                        {{ __('admin::app.conversation.total-sale') }}
                    </div>
                ...
                <div class="conversation-card">
                    <div class="title">
                        {{ __('admin::app.conversation.average-sale') }}
                    </div>
                ...
                <div class="left-card-container graph">
                    <div class="card">
                        <div class="card-title" style="margin-bottom: 30px;">
                            {{ __('admin::app.conversation.sales') }}
                        </div>
                ...
                <div class="right-card-container category">
                    <div class="card">
                        <div class="card-title">
                            {{ __('admin::app.conversation.top-performing-categories') }}
                        </div>
                                    ...
                                    <li>
                                        <a href="{{ route('admin.catalog.categories.edit', $item->category_id) }}">
                                            <div class="description">
                                                ...
                                                <div class="info">
                                                    {{ __('admin::app.conversation.product-count', ['count' => $item->total_products]) }}
                                                    &nbsp;.&nbsp;
                                                    {{ __('admin::app.conversation.sale-count', ['count' => $item->total_qty_ordered]) }}
                                                </div>
                                            </div>
            ...
            <div class="sale-stock">
                <div class="card">
                    <div class="card-title">
                        {{ __('admin::app.conversation.top-selling-products') }}
                    </div>
                ...
                <div class="card">
                    <div class="card-title">
                        {{ __('admin::app.conversation.customer-with-most-sales') }}
                    </div>
                                ...
                                <li>
                                    ...
                                    @endif
                                        ...
                                        <div class="description">
                                            ...
                                            <div class="info">
                                                {{ __('admin::app.conversation.order-count', ['count' => $item->total_orders]) }}
                                                    &nbsp;.&nbsp;
                                                {{ __('admin::app.conversation.revenue', [
                ...
                <div class="card">
                    <div class="card-title">
                        {{ __('admin::app.conversation.stock-threshold') }}
                    </div>
                                ...
                                <li>
                                    <a href="{{ route('admin.catalog.products.edit', $item->product_id) }}">
                                        ...
                                        <div class="description">
                                            ...
                                            <div class="info">
                                                {{ __('admin::app.conversation.qty-left', ['qty' => $item->total_qty]) }}
                                            </div>
                                        </div>
    ...
    <script type="text/x-template" id="date-filter-template">
        <div>
            <div class="control-group date">
                <date @onChange="applyFilter('start', $event)"><input type="text" class="control" id="start_date" value="{{ $startDate->format('Y-m-d') }}" placeholder="{{ __('admin::app.conversation.from') }}" v-model="start"/></date>
            </div>

            <div class="control-group date">
                <date @onChange="applyFilter('end', $event)"><input type="text" class="control" id="end_date" value="{{ $endDate->format('Y-m-d') }}" placeholder="{{ __('admin::app.conversation.to') }}" v-model="end"/></date>
            </div>
        </div>
    </script>
